...
class ProcessMessageException(ATComponentException):
    ...
    def __init__(
        ...
        *args
        ...
        super().__init__(msg, session, component,
                         processed_message_id, processed_message, *args)
...
class ExecMethodException(ProcessMessageException):
    ...
    def __init__(
        ...
        session: "BasicSession",
        component: "BaseComponent",
        processed_message_id: UUID | str,
        processed_message: dict,
        *args,
        method: "BaseComponentMethod" = None
    ) -> None:
        super().__init__(msg, session, component,
                         processed_message_id, processed_message, *args, method)
        self.method = method
...
class MethodArgumentSchemaException(ExecMethodException):
    ...
    def __init__(
        ...
        *args
        ...
        super().__init__(
            msg, session, component, processed_message_id, processed_message, argument, *
            args, method=method
        )
